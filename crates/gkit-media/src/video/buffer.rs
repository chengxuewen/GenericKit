...
pub trait VideoBuffer: fmt::Debug + Send + Sync {
    ...
    fn scale(&self, scaled_width: u32, scaled_height: u32) -> Result<I420Buffer, crate::protocols::rtc::peer::MediaError>;

    /// Convert to I420 format.
    fn to_i420(&self) -> Result<I420Buffer, crate::protocols::rtc::peer::MediaError>;
}
...
impl VideoBuffer for I422Buffer {
    ...
    fn scale(&self, w: u32, h: u32) -> Result<I420Buffer, crate::protocols::rtc::peer::MediaError> {
